...
class ArticlesSpider(scrapy.Spider):
    ...
    def start_request(self):
        url ="http://trtworld.com/" #not so sure why this is necessary
 ...
 #type in console scrapy crawl -o article_links.json -t json Articles

 #main error: yield is outside function