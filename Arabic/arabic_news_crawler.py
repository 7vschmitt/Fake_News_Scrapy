...
with open('arabic_news.json') as data_file:
        ...
        for entry in d.entries:
            ...
            if hasattr(entry, 'published'):
                ...
                try: #here Newspaper library comes into play to scrape the content of the links
                    content = Article(entry.link, language="ar") #try to scrape articles in arabic
                    content.download()
                    content.parse()
...
try:
    with open('scraped_articles_ar.json', 'w') as outfile:
